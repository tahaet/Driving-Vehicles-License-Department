...
namespace MySolution.Applications.International_Licenses
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            if(ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.LicenseClass != (int)clsApplication.enApplicationType.NewInternationalLicense)
            {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblExpirationDate.Text = clsFormat.DateToShort(DateTime.Now.AddYears((int)clsInternationalLicense.enDefaultValidityLength.OrdinaryInernationalLicense));
