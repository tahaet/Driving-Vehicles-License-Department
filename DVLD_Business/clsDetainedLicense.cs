...
namespace DVLD_Business
{
    public class clsDetainedLicense
    {
                   ...
                   int ReleasedByUserID, int ReleaseApplicationID)
        {
            ...
            this.ReleasedByUser = clsUser.FindByUserID(this.ReleasedByUserID);
            Mode = enMode.Update;
        ...
        public bool ReleaseDetainedLicense(int ReleaseByUserID , int ReleaseApplication)
        {
            return clsDetainedLicenseData.ReleaseDetainedLicense(this.DetainID, ReleaseByUserID, ReleaseApplication);  
        }
    }
}
